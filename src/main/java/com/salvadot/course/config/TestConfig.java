...
import com.salvadot.course.entities.Payment;
...
import com.salvadot.course.repositories.OrderItemRepository;
import com.salvadot.course.repositories.OrderRepository;
import com.salvadot.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null, Instant.parse("2020-05-22T07:53:05Z"), o1);
		o1.setPayment(pay1);
